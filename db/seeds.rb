...
users = User.create([{ name: "Walter White", username: "Heisenberg", email: "savewalterwhite@gmail.com", bio: "Jackson Isai? Tu quoque ... A te quidem a ante. Vos scitis quod blinking res Ive 'been vocans super vos? Et conteram illud", password: "ZgXUUSKD", password_confirmation: "ZgXUUSKD" }, { name: "Jesse Pinkman", username: "CapnCook", email: "jessepinkman@gmail.com", bio: "Ludum mutavit. Verbum est ex. Et", password: "TryWBV6b", password_confirmation: "TryWBV6b" }, { name: "Skyler White", username: "whitebitch", email: "skylerwhite@gmail.com", bio: "sunt occidat. Videtur quod est super omne oppidum.", password: "123456", password_confirmation: "123456" }, { name: "Mike Ehrmantraut", username: "mikehr", email: "mike@gmail.com", bio: "", password: "123456", password_confirmation: "123456" }, { name: "Saul Goodman", username: "SlippinJimmy", email: "bettercallsaul@gmail.com", bio: "Hey, I just talked you down from a death sentence to a six months' probation. I'm the best lawyer ever", password: "gFVMLBvR", password_confirmation: "gFVMLBvR" }])
